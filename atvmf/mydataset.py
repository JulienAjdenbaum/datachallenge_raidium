...
class CVCClinicDB_Dataset(data.Dataset):
    ...
    def __init__(self, root=None, dataset_type='train',cross='1', transform=None):
        ...
        self.cross = cross
        print(root + "datamodel/{}_data_{}.npy".format(self.dataset_type, self.cross))
        ...
        # l = self.item_gt
        # l_final = np.zeros((l.shape[0], n_cat, l.shape[1], l.shape[2]))
        # for i in range(1, n_cat+1):
        #     l_final[:, i-1, :, :] = l==i
        # self.item_gt = l_final
        
        print(self.item_image.shape)
